...
- [`imperative-startup-config-source-comparison`](adr/0058-configuration-source-acquisition-triad-comparison.md)
- [`csharp-startup-config-source-comparison`](adr/0058-configuration-source-acquisition-triad-comparison.md)
- [`langext-startup-config-source-comparison`](adr/0058-configuration-source-acquisition-triad-comparison.md)
- [`imperative-startup-config-loading-comparison`](adr/0056-configuration-loading-before-validation-triad-comparison.md)(adr/0056-configuration-loading-before-validation-triad-comparison.md)
...
- [`imperative-startup-config-decoding-comparison`](adr/0057-configuration-typed-decoding-triad-comparison.md)
- [`csharp-startup-config-decoding-comparison`](adr/0057-configuration-typed-decoding-triad-comparison.md)
- [`langext-startup-config-decoding-comparison`](adr/0057-configuration-typed-decoding-triad-comparison.md)
- [`imperative-db-text-store`](adr/0044-database-text-store-triad-comparison.md)(adr/0044-database-text-store-triad-comparison.md)
